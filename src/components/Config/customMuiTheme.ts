// desapp-2025c1-grupo-2/tarifas-de-costos-frontend/tarifas-de-costos-frontend-feature-final/src/components/Config/customMuiTheme.ts
    ...
    MuiMenu: {
      styleOverrides: {
        paper: {
          ...
          // --- INICIO DE LA MODIFICACIÓN ---
          // Añadimos la regla para centrar el subheader
