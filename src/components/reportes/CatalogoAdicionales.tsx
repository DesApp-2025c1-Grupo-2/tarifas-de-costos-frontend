...
import { esES as esESGrid } from "@mui/x-data-grid/locales"; // Importar localización
...
const columns: GridColDef[] = [
  ...
  { 
    ...
    // Aseguramos que 'value' no sea null/undefined antes de llamar a toFixed.
    // Usamos el operador nullish coalescing (??) para que si value es null o undefined,
    // se use 0 en su lugar.
  ...
  useEffect(() => {
    const fetchAdicionales = async () => {
      try {
        ...
        // Filtrar adicionales donde activo no sea false
